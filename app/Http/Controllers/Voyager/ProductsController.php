...
class ProductsController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $categoriesForProduct = Product::find($id)->categories()->get();
    ...
    public function edit(Request $request, $id)
    {
        ...
        $CategoryForProduct = $prodduct->categories()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','categories','CategoryForProduct'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->selectedCategories($request,$data->id);
    ...
    public function selectedCategories(Request $request, $id){
