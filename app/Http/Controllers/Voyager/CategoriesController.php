...
class CategoriesController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $productForCategories  = Category::find($id)->products()->get(); 
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted','category','productForCategories'));
    }
